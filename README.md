...
| `/settings`                                     | Role-branched: super admin (profile, fees, integrations, staff, logs) / admin (profile, savings & loan settings, co-op settings, staff) | [settings-page.md](./documentation/settings-page.md), [admin-settings-page.md](./documentation/admin-settings-page.md) |
| `/settings/loans/new`                           | Admin: create/edit a loan type (full page)                                                                                              | [admin-settings-page.md](./documentation/admin-settings-page.md)                                                       |
...
- [x] Settings (super admin: profile + password, fees & collections account, dual Paystack/Flutterwave integration toggles, platform staff users/roles with full edit/disable/remove actions, real app-wide audit log with live IP-resolved location — see [settings-page.md](./documentation/settings-page.md). admin: profile + personal bank account, savings/loan type catalog management (add/edit/enable/disable), co-operative profile + bank account, shared user/role management — see [admin-settings-page.md](./documentation/admin-settings-page.md))
- [x] Light/dark theme
